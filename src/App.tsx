      ...
      <header className="relative h-screen">
        ...
        <nav className="relative z-10 flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
          <div className="flex items-center space-x-2 text-white">
            ...
            <span className="text-2xl font-bold">Instavan</span>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">contact@instavan.fr</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">Instavan</span>
              </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Instvan. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
    </div>
